...
USER_BIN_NAMES := ls cat wc uname pwd mkdir rm cp mv wget grep touch head tail sort find login whoami id passwd useradd userdel sudo poweroff reboot sleep kill ps chmod chown stat free df
